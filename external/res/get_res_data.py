...
def get_res_data(zip, max_query_results=5, num_entries_to_search=10000, t_out=10):

    res_dataset_domain = "https://data.cityofnewyork.us"
    ...
    try:
        results = client.get(
            ...
            select="dba, boro, zipcode, cuisine_description, action, violation_description, score",
