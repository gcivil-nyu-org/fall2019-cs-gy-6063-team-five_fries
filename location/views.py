...
def contact_landlord(request, pk, apk):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            messages.success(request, "An email has been sent to the landlord!", extra_tags="email")
...
def favorites(request, pk):
    ...
    if apartment not in user.favorites.all():
        ...
        messages.success(request, "This apartment has been added to your favorites!", extra_tags="apartment")
    else:
        user.favorites.remove(apartment)
        messages.success(
            request, "This apartment has been removed from your favorites!", extra_tags="apartment")
