# Generated by Django 2.2.6 on 2019-10-24 04:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'A user with that username already exists.'}, help_text='Required. 150 characters or fewer. Letters, digits and @/./+/-/_ only.', max_length=150, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator()], verbose_name='username')), # noqa E501
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(default='', max_length=128, region=None)), # noqa E501
                ('current_location', models.CharField(default='', max_length=255)),
                ('work_location', models.CharField(default='', max_length=255)),
                ('user_type', models.CharField(choices=[('T', 'Tenant'), ('R', 'Renter'), ('L', 'Landlord')], default='R', max_length=2)), # noqa E501
