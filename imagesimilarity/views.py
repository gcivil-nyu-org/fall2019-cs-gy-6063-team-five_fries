...
from citystreets.settings import MEDIA_ROOT
...
def sim_apt(request):
    if request.POST:
        ...
        return render(request, "imagesimilarity/similar_apartments.html", {"cos_sim": 'Score: {0:.2f}'.format(float(cos_sim)),
                                              "post": True,
                                              "img1src": file1_name,
                                              "img2src": file2_name,
                                              })
    return render(request, "imagesimilarity/similar_apartments.html", {'post': False})
